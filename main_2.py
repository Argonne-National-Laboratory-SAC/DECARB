...
activity_non_combust ['Category, Subcategory'] = activity_non_combust ['Category'] + ', ' + activity_non_combust ['Subcategory'] 
...
if save_interim_files == True:
    activity_BAU.to_csv(interim_path_prefix + '\\' + 'interim_activity_BAU.csv')
